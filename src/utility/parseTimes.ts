...
/**
 * Parse time strings like "9 AM – 4 PM & 9 PM – 4 AM" to time ranges
 */
...
/**
 * Checks if a specific hour is within a time range
 */
...
/**
 * Gets all hours that fall within the given time ranges
 */
